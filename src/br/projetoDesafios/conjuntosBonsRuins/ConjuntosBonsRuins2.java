package br.projetoDesafios.conjuntosBonsRuins;

import java.util.*;
import java.util.stream.Collectors;

public class ConjuntosBonsRuins2 {
           ...
           int inteiro = Integer.parseInt(sc.nextLine());
            ...
            for (int a = 1; a <= inteiro ; a++) {
                ...
                if (a == inteiro) {
                    ...
                    String conjuntoOrdenado = conjuntos.stream().sorted().collect(Collectors.joining(" "));
